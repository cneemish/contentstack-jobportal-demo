...
function ConcurrencyQueue(_ref) {
  ...
  var _retryNetworkError = function retryNetworkError(error, errorInfo, attempt) {
    ...
    return new Promise(function (resolve, reject) {
      setTimeout(function () {
        ...
        var sanitizedConfig = (0, _Util.validateAndSanitizeConfig)(updateRequestConfig(error, "Network retry ".concat(attempt), delay));
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 1:
            ...
            _this.running.forEach(function (_ref3) {
              ...
              var sanitizedConfig = (0, _Util.validateAndSanitizeConfig)(request);
  ...
  var responseErrorHandler = function responseErrorHandler(error) {
    ...
    if (!response) {
      ...
      var sanitizedConfig = (0, _Util.validateAndSanitizeConfig)(updateRequestConfig(error, retryErrorType, wait));
  ...
  this.retry = function (error, retryErrorType, retryCount, waittime) {
    ...
    return new Promise(function (resolve) {
      return setTimeout(function () {
        // SSRF Prevention: Validate URL before making request
        var sanitizedConfig = (0, _Util.validateAndSanitizeConfig)(updateRequestConfig(error, retryErrorType, delaytime));
